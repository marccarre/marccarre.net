...
1. Spoofing: an entity pretending to be something it is not, generally by capturing a legitimate user’s credentials, e.g.: [brute force](https://www.owasp.org/index.php/Brute_force_attack), [CSRF](https://www.owasp.org/index.php/Cross-Site_Request_Forgery_(CSRF)).
